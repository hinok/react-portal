...
var PortalWithState = function (_React$Component) {
  ...
  function PortalWithState(props) {
    ...
    _this.clickListener = false;
    _this.keydownListener = false;
  ...
  _createClass(PortalWithState, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var shouldFlushListeners = nextProps.closeOnEsc !== this.props.closeOnEsc || nextProps.closeOnOutsideClick !== this.props.closeOnOutsideClick;
    ...
    value: function addEventListeners() {
      var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : required();
